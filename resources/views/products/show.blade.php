                ...
                <div class="lg:w-1/2 p-8 flex flex-col">
                    ...
                    <div class="border-t border-brand-gray-100 pt-6">
                        ...
                        <button 
                            ...
                            class="w-full bg-konbini-green text-white py-3 rounded-lg font-medium hover:bg-green-600 transition-colors duration-200 disabled:bg-brand-gray-200 disabled:text-brand-gray-400 disabled:cursor-not-allowed"
                        >
                            Add to Trainer's Bag
                        </button>
                    </div>
                </div>
            </div>
